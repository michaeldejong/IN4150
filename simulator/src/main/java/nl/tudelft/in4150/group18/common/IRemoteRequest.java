 ...
 */
public interface IRemoteRequest<M extends IRequest, R> extends Remote {

	/**
	 * This method will be called upon receiving a {@link IRequest}.
	 * 
	 ...
	 */
	R onRequest(M message, Address from) throws RemoteException;
